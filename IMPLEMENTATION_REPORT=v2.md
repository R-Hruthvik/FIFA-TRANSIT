...
## Phase 2: Staff Registration + Approval Queue ❌ NOT STARTED

### Status: NOT IMPLEMENTED
**All Phase 2 work was stashed/reverted. No Phase 2 files are present in the working tree.**
...
- `src/components/admin/StaffApprovalQueue.tsx` - Show registration details + approve/reject actions

### Still Needs:
- [ ] All Phase 2 files need to be created from scratch
- [ ] Admin approve/reject API endpoints
  - `src/app/api/admin/staff/[id]/approve/route.ts`
  - `src/app/api/admin/staff/[id]/reject/route.ts`
